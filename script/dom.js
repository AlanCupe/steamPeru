...
const juego2 = new juego(
  ...
  "neon",
  "ACCION",
  "assets/img/accion/neonWhite.avif"
);
const juego3 = new juego(
  ...
  "counter",
  "ACCION",
  "assets/img/accion/counterStrike.png"
);
const juego4 = new juego(
  ...
  "hife",
  "ACCION",
  "assets/img/accion/hifeLife.jpg"
);
const juego5 = new juego(
  ...
  "lost",
  "ACCION",
  "assets/img/accion/lostArk.webp"
);
...
const juego7 = new juego(
  ...
  "league",
  "MOBA",
  "assets/img/moba/leagueOfLeguends.jpg"
);
...
const juego9 = new juego(
  ...
  "lords",
  "MOBA",
  "assets/img/moba/lordsMobile.jpg"
);
...
const juego11 = new juego(
  ...
  "apex",
  "AVENTURA",
  "assets/img/aventura/apex-legends.jpg"
);
const juego12 = new juego(
  ...
  "destiny",
  "AVENTURA",
  "assets/img/aventura/destiny2.jpg"
);
...
const juego14 = new juego(
  ...
  "god",
  "AVENTURA",
  "assets/img/aventura/godofWar.jpeg"
);
const juego15 = new juego(
  ...
  "forza",
  "AVENTURA",
  "assets/img/aventura/forzaHorizon.jpg"
);
//PUSHEANDO A SU ARREGLO RESPECTIVO
  ...
  for (let i of arreglo) {
    ...
    window.addEventListener("load", () => {
      ...
      verCarrito.addEventListener("click", () => {
        ...
        juegosC.innerHTML = `<div class="cardJuego mb-4">
    ...
    <button  id="${obtenerGame.idProducto}" class="cardJuego__btnComprar">Comprar</button>
    </div>`;
      ...
      closeCarrito = document.getElementById("close");
